...
const ptBR: Translation = {
  ...
  beneficios: {
    ...
    items: [
      ...
      {
        title: 'Resposta rápida, do início ao fim',
        desc: 'Falo direto com você, sem intermediários. Você acompanha cada etapa do projeto e nunca fica no escuro sobre o que está acontecendo.',
      },
      {
  ...
  contato: {
    ...
    navHint: "Use ← → para navegar e Enter para continuar",
    btnWhatsApp: "Conversar no WhatsApp",
    btnEmail: "Enviar um email",
    verifyLabel: "Verificação anti-bot",
    verifying: "Verificando se você é humano…",
    verified: "Verificado. Pode continuar!",
    verifyError: "Falha na verificação. Tente novamente.",
    questions: {
      projeto: {
  ...
  privacy: {
    ...
    dataCollected: 'Coletamos suas preferências de visualização e respostas do quiz, fornecidas de forma voluntária.',
    trackersTitle: 'Rastreamento',
    trackers: 'Este site não utiliza cookies nem rastreadores de terceiros. Uma ferramenta de análise interna registra apenas páginas visitadas e origem do acesso, sem identificar você pessoalmente.',
    usageTitle: 'Uso dos Dados',
    usage: 'Utilizamos os dados exclusivamente para responder ao seu contato, melhorar sua experiência e entender o desempenho do site.',
    contactTitle: 'Contato',
    contact: 'Para dúvidas ou solicitações de exclusão de dados, envie um e‑mail para contact@ismaeltech.com.',
